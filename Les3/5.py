...
def sum_numbers ():
    ...
    ex = False
    while ex == False:
        number = input('Введите числа через пробел. Для завершения введите q: ').split()
        ...
        sum_res = sum_res + res
        print(f'Итоговая сумма введеных элементов равна {sum_res}')
    print(f'Финальная итоговая сумма введеных чисел равна {sum_res}')
